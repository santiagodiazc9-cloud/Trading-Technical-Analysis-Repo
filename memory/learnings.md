...
- 2026-05-22 (Pre-Market): **Beat-and-raise that the market sells = momentum-divergence warning, not a buy signal.** NVDA delivered a textbook Q1 FY27 blowout (rev +85% YoY, double EPS beat, Q2 guide $91B vs $86.8B, $80B buyback) and the stock fell four straight sessions with a daily MACD bearish crossover. Price sat inside the prior-defined post-earnings watch zone ($215-220, RSI <65) but the momentum filter (MACD must confirm) correctly blocked a proposal — buying a fundamentally-great name whose tape says distribution is the trap. Rule of thumb: a blowout earnings report is a fundamental catalyst, not a technical entry. The setup is the pullback that holds *with momentum confirming*, not the headline.
